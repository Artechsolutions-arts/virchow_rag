...
class RAGConfig:
    def __init__(self):
        ...
        self.embedding_dim:        int   = int(os.getenv("EMBEDDING_DIM", str(EMBEDDING_DIM)))
        self.embedding_batch:      int   = int(os.getenv("EMBEDDING_BATCH_SIZE", "64"))
        self.embedding_device:     str   = os.getenv("EMBEDDING_DEVICE", "cpu")
        # Ollama
        self.ollama_base_url:      str   = os.getenv("OLLAMA_BASE_URL",    OLLAMA_BASE_URL)
        self.ollama_ocr_model:     str   = os.getenv("OLLAMA_OCR_MODEL",   OLLAMA_OCR_MODEL)
        self.ollama_embed_model:   str   = os.getenv("OLLAMA_EMBED_MODEL", OLLAMA_EMBED_MODEL)
        self.upload_dir:           Path  = UPLOAD_DIR
        # Chunking — Qwen3-Embedding-0.6B supports 32k token context; 600-token
        # chunks still give good retrieval precision while keeping batch memory
        # reasonable. Override via CHUNK_SIZE / CHUNK_OVERLAP env if needed.
        ...
        self.SEAWEEDFS_FILER_URL:  str   = os.getenv("SEAWEEDFS_FILER_URL",  "http://192.168.10.10:889")
        self.SEAWEEDFS_MASTER_URL: str   = os.getenv("SEAWEEDFS_MASTER_URL", "http://192.168.10.10:933")
        self.SEAWEEDFS_S3_ENDPOINT:str   = os.getenv("SEAWEEDFS_S3_ENDPOINT","http://192.168.10.10:833")
