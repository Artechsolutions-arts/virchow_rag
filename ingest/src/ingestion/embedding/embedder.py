...
MxbaiEmbedder
=============
Sentence-Transformers wrapper around Qwen/Qwen3-Embedding-0.6B.
...
- Qwen3-Embedding-0.6B uses model_type=qwen3, natively supported by transformers ≥4.51
"""
...
class MxbaiEmbedder:
    ...
    def __init__(self, model_name: str = None, device: str = None, batch_size: int = None):
        self._model_name  = model_name  or getattr(cfg, "embedding_model",  "Qwen/Qwen3-Embedding-0.6B")
