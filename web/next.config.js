...
const nextConfig = {
  ...
  async rewrites() {
    return {
      // afterFiles: Next.js route handlers (app/api/**) take priority over these rewrites.
      // beforeFiles would override route handlers — use afterFiles so /api/chat/* handlers run.
      beforeFiles: [
        {
