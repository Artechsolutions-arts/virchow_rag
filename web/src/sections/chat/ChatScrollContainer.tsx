    ...
    (
      ...
      useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
          // When loading an existing conversation, scroll to bottom so the
          // latest messages are visible. For live in-session anchor changes
          // (e.g. Q2 anchor replacing Q1 anchor) do NOT anchor-scroll —
          // the MutationObserver auto-scroll already keeps up with new content
          // and anchor-scrolling would push earlier messages off the top.
